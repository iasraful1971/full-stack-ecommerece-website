...
import {
  ...
  ALL_PRODUCT_FAIL,
  ALL_PRODUCT_REQUEST,
  ALL_PRODUCT_SUCCESS, ALL_RECENT_PRODUCT_FAIL, ALL_RECENT_PRODUCT_REQUEST,
  ALL_RECENT_PRODUCT_SUCCESS, ALL_REVIEW_FAIL, ALL_REVIEW_REQUEST,
  ALL_REVIEW_SUCCESS, CLEAR_ERRORS,
  DELETE_PRODUCT_FAIL,
...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: ALL_RECENT_PRODUCT_FAIL, payload: error.response.data.message });
  }
};
